...
Deskripsi : Main Yuk! adalah sebuah permainan seberapa suka pacar kita. Main Yuk!
            ...
            Swal.fire({
                ...
                Swal.fire({
                    ...
                    function () {
                        ...
                        console.log(nama);
                        Swal.fire({
                            title: 'Kamu suka gak sama aku?',
                            icon: 'question',
                            showCancelButton: true,
                            confirmButtonColor: '#3085d6',
                            cancelButtonColor: '#d33',
                            confirmButtonText: 'Suka banget',
                            ...
                            if (result.isConfirmed) {
                                Swal.fire({
                                    title: 'Aku juga suka banget sama kamu',
                                    showClass: {
                                        popup: 'animate__animated animate__jackInTheBox'
                                    },
                                    hideClass: {
                                    ...
                                    Swal.queue([{
                                        title: 'Seberapa suka kamu ke aku?',
                                        confirmButtonText: 'Submit',
                                        showCancelButton: true,
                                        text: 'Coba isi pengen tau seberapa suka kamu ke aku',
                                        showClass: {
                                            popup: 'animate__animated animate__jackInTheBox'
                                        },
                                        hideClass: {
                                        ...
                                        preConfirm: function (value) {
                                            Swal.insertQueueStep({
                                                title: 'Terima kasih sudah suka sama aku' + ' ' + value + '%',
                                                icon: "info",
                                                showClass: {
                                                    popup: 'animate__animated animate__jackInTheBox'
                                                },
                                        ...
                                        Swal.fire({
                                            title: 'Sekarang kamu kangen sama aku gak?',
                                            icon: 'question',
                                            type: 'question',
                                            showClass: {
                                                popup: 'animate__animated animate__jackInTheBox'
                                            ...
                                            if (result.isConfirmed) {
                                                Swal.fire({
                                                    title: 'Sama aku juga kangen sama kamu',
                                                    icon: 'info',
                                                    showClass: {
                                                        popup: 'animate__animated animate__jackInTheBox'
                                                    },
                                ...
                                Swal.fire({
                                    title: 'Beneran? Aku tanya sekali lagi nih. Suka gak sama aku?',
                                    icon: 'question',
                                    text: 'Coba jawab yang bener',
                                    showCancelButton: true,
                                    confirmButtonText: 'Beneran, enggak',
                                    cancelButtonText: 'Ya, suka lah',
                                    ...
                                    if (result.isConfirmed) {
                                        ...
                                        Swal.fire({
                                            ...
                                            Swal.queue([{
                                                title: 'Seberapa suka kamu sama aku?',
                                                confirmButtonText: 'Submit',
                                                showCancelButton: true,
                                                text: 'Coba isi pengen tau seberapa suka kamu sama aku',
                                                showClass: {
                                                    popup: 'animate__animated animate__jackInTheBox'
                                                },
                                                hideClass: {
